...
describe 'Control-plane etcd must have a certificate for communication.' do
  it 'is not a finding in Amazon EKS because The etcd certificate file is configured by AWS on control plane; not customer-configurable in EKS. Not a Finding – AWS responsibility; see https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html#control-plane' do
